...
uint32 io_info[PWM_CHANNELS][3] = {
  ...
  {PERIPHS_IO_MUX_MTCK_U,  FUNC_GPIO13, 5}, //G
  {PERIPHS_IO_MUX_MTMS_U,  FUNC_GPIO14, 13}, //B
  {PERIPHS_IO_MUX_GPIO5_U, FUNC_GPIO5 ,  14}, //W
};
...
void setup() {
  ...
  wifiManager.autoConnect("LAMP_3-Boxes");
  if (! light_state)  {
  ...
  ArduinoOTA.setHostname("LAMP_3-Boxes");
