...
//Generic ESP8266, Flash Size: 1M (128k SPIFFS)
...
uint32 io_info[PWM_CHANNELS][3] = {
  // MUX, FUNC, PIN
  {PERIPHS_IO_MUX_MTDI_U,  FUNC_GPIO12, 2}, //R
  {PERIPHS_IO_MUX_MTCK_U,  FUNC_GPIO13, 3}, //G
  {PERIPHS_IO_MUX_MTMS_U,  FUNC_GPIO14, 0}, //B
  {PERIPHS_IO_MUX_GPIO5_U, FUNC_GPIO5 ,  1},//W
};
...
void setup() {
  ...
  wifiManager.autoConnect("LAMP_Glass-Light");
  if (! light_state)  {
  ...
  ArduinoOTA.setHostname("LAMP_Glass-Light");
