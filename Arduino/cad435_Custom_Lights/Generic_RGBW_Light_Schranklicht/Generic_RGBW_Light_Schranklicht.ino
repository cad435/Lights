...
//Generic ESP8266, Flash-Size: 2M (1M SPIFFS)
...
uint32 io_info[PWM_CHANNELS][3] = {
  // MUX, FUNC, PIN
  {PERIPHS_IO_MUX_MTDI_U,  FUNC_GPIO12, 0}, //R
  {PERIPHS_IO_MUX_MTCK_U,  FUNC_GPIO13, 3}, //G
  {PERIPHS_IO_MUX_MTMS_U,  FUNC_GPIO14, 2}, //B
...
void setup() {
  ...
  wifiManager.autoConnect("LAMP_Schranklicht");
  if (! light_state)  {
  ...
  ArduinoOTA.setHostname("LAMP_Schranklicht");
