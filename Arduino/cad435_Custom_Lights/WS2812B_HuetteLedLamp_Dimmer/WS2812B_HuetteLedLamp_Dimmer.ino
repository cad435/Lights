...
#define lightsCount 7
#define pixelCount 7


#define MAX_BRIGHTNESS_R 200
#define MAX_BRIGHTNESS_G 180
#define MAX_BRIGHTNESS_B 180
...
RgbColor red = RgbColor(MAX_BRIGHTNESS_R, 0, 0);
RgbColor green = RgbColor(0, MAX_BRIGHTNESS_G, 0);
RgbColor white = RgbColor(MAX_BRIGHTNESS_R, MAX_BRIGHTNESS_G, MAX_BRIGHTNESS_B);
...
void lightEngine() {
  ...
  for (int i = 0; i < lightsCount; i++) {
    if (rgb[i][0] > MAX_BRIGHTNESS_R)
      rgb[i][0] = (int) MAX_BRIGHTNESS_R;

    if (rgb[i][1] > MAX_BRIGHTNESS_G)
      rgb[i][1] = (int) MAX_BRIGHTNESS_G;

    if (rgb[i][2] > MAX_BRIGHTNESS_B)
      rgb[i][2] = (int) MAX_BRIGHTNESS_B;
  }
...
void setup() {
  ...
  ArduinoOTA.setHostname("Huette_Licht_1");
